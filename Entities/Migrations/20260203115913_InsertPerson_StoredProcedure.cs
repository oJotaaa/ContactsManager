    ...
    public partial class InsertPerson_StoredProcedure : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string sp_InsertPerson = @"
                ...
                (@PersonID uniqueidentifier, @PersonName nvarchar(50), @Email nvarchar(100), @DateOfBirth datetime2(7), @Gender nvarchar(10), @CountryID uniqueidentifier, @Address nvarchar(200), @ReceiveNewsLetters bit)
                AS BEGIN
